...
static void R1dataProcess(SCA_Handler_t* pSCA, struct rt_can_msg* RxMsg);
static void R2dataProcess(SCA_Handler_t* pSCA, struct rt_can_msg* RxMsg);
static void R3dataProcess(SCA_Handler_t* pSCA, struct rt_can_msg* RxMsg);
static void R4dataProcess(SCA_Handler_t* pSCA, struct rt_can_msg* RxMsg);
static void WriteDataProcess(SCA_Handler_t* pSCA, struct rt_can_msg* RxMsg);
...
/**
  ...
  * @返	回	无
  */
static void R5dataProcess(SCA_Handler_t* pSCA, struct rt_can_msg* RxMsg)
{
	/* 装填序列号 */
...
{
	SCA_Handler_t* pSCA = getInstance((uint8_t)RxMsg->id);
