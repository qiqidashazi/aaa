...
UNS16 Interpolation_value[2];		/* Mapped at index 0x60C1, subindex 0x00 */
// 接收 rpdo
...
/* index 0x1400 :   Receive PDO 1 Parameter. */
                    ...
                    UNS32 master402_obj1400_COB_ID_used_by_PDO = 0x202;	/* 386 */
...
/* index 0x1401 :   Receive PDO 2 Parameter. */
                    ...
                    UNS32 master402_obj1401_COB_ID_used_by_PDO = 0x303;	/* 642 */
...
/* index 0x1402 :   Receive PDO 3 Parameter. */
                    ...
                    UNS32 master402_obj1402_COB_ID_used_by_PDO = 0x404;	/* 1024 */
...
/* index 0x1600 :   Receive PDO 1 Mapping. */
                    UNS8 master402_highestSubIndex_obj1600 = 3; /* number of subindex - 1*/
                    ...
                    subindex master402_Index1600[] = 
                     {
                       ...
                       { RW, uint32, sizeof (UNS32), (void*)&master402_obj1600[2], NULL }
                     };

/* index 0x1601 :   Receive PDO 2 Mapping. */
                    UNS8 master402_highestSubIndex_obj1601 = 3; /* number of subindex - 1*/
                    ...
                    subindex master402_Index1601[] = 
                     {
                       ...
                       { RW, uint32, sizeof (UNS32), (void*)&master402_obj1601[2], NULL }
                     };

/* index 0x1602 :   Receive PDO 3 Mapping. */
                    UNS8 master402_highestSubIndex_obj1602 = 3; /* number of subindex - 1*/
                    ...
                    subindex master402_Index1602[] = 
                    {
                       ...
                       { RW, uint32, sizeof (UNS32), (void*)&master402_obj1602[2], NULL }
                    };

/* index 0x1603 :   Receive PDO 4 Mapping. */
                    UNS8 master402_highestSubIndex_obj1603 = 0; /* number of subindex - 1*/
...
/*
    ...
    目前配置主站 TPDO 配置: 202,303,404分别对应不同的伺服节.
                 RPDO 配置：
...
/* index 0x1800 :   Transmit PDO 1 Parameter. */
                    ...
                    UNS32 master402_obj1800_COB_ID_used_by_PDO = 0x182;	/* 514 */
...
/* index 0x1801 :   Transmit PDO 2 Parameter. */
                    ...
                    UNS32 master402_obj1801_COB_ID_used_by_PDO = 0x283;	/* 770 */
...
/* index 0x1802 :   Transmit PDO 3 Parameter. */
                    ...
                    UNS32 master402_obj1802_COB_ID_used_by_PDO = 0x384;	/* 896 */
...
/* index 0x1803 :   Transmit PDO 4 Parameter. */
                    ...
                    UNS32 master402_obj1803_COB_ID_used_by_PDO = 0x485;	/* 1152 */
                    UNS8 master402_obj1803_Transmission_Type = 0x1;	/* 0 */
...
/* index 0x1A03 :   Transmit PDO 4 Mapping. */
                    UNS8 master402_highestSubIndex_obj1A03 = 0; /* number of subindex - 1*/
...
/* index 0x6502 :   Mapped variable Supported drive modes */
                    ...
                    UNS16 Interpolation_value[2]; 
                    subindex master402_Index60C1[] = 
                    {
                      { RO, uint8,  sizeof (UNS16), (void*)&master402_60C1,       NULL },
