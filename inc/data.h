...
struct struct_CO_Data {
	...
	const indextable *objdict;		//索引表
	s_PDO_status *PDO_status;		//状态
...
#define CANOPEN_NODE_DATA_INITIALIZER(NODE_PREFIX) {\
	...
	\
	/* NMT-heartbeat */\
	& NODE_PREFIX ## _highestSubIndex_obj1016, /* ConsumerHeartbeatCount  在0x16下为1*/\
	NODE_PREFIX ## _obj1016,                   /* ConsumerHeartbeatEntries master402_obj1016 */\
	NODE_PREFIX ## _heartBeatTimers,           /* ConsumerHeartBeatTimers 	-1	*/\
	& NODE_PREFIX ## _obj1017,                 /* ProducerHeartBeatTime 	0	*/\
